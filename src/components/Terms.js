...
// Reader Mode collects absolutely zero personal data from users and doesn't track any pages visited by users via our extensions and app. For Reader Mode Free, Pro and Education, all data such as highlights, notes and pages are stored locally on the computer which you have installed Reader Mode on. For Reader Mode Premium, these data are stored on our secure server and only you can access these data via your connected account.
// Meanwhile for shared pages, a random, unique, and anonymous string is used to verify identity, not anything related to your personal information.
...
const Terms = ({}) => {
  return (
    <>
      ...
      <p>Welcome to DesignValley!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of DesignValley's Website, located at https://www.designvalley.club.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use DesignValley if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing DesignValley, you agreed to
        use cookies in agreement with the DesignValley's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, DesignValley and/or its licensors own the
        intellectual property rights for all material on DesignValley. All
        intellectual property rights are reserved. You may access this from
        DesignValley for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from DesignValley</li>
        <li>Sell, rent or sub-license material from DesignValley</li>
        <li>Reproduce, duplicate or copy material from DesignValley</li>
        <li>Redistribute content from DesignValley</li>
      </ul>
      ...
      <p>
        ...
        DesignValley does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of DesignValley,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, DesignValley shall not be
      ...
      <p>
        DesignValley reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant DesignValley a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of DesignValley; and (d) the link
      ...
      <p>
        ...
        e-mail to DesignValley. Please include your name, your organization
      ...
      <p>
        No use of DesignValley's logo or other artwork will be allowed for
