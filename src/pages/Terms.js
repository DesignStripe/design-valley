...
const Terms = ({}) => {
  ...
  return (
    <Container>
      ...
      <Section
        title="Welcome to DesignValley!"
        paragraphs={[
          "These terms and conditions outline the rules and regulations for the use of DesignValley's Website, located at https://www.designvalley.club.",
          "By accessing this website we assume you accept these terms and conditions. Do not continue to use DesignValley if you do not agree to take all of the terms and conditions stated on this page.",
          <>
